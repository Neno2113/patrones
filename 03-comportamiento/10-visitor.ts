...
interface Visitor {
    ...
    visirFerrisWheel( ferrisWheel: FerrisWheel ): void;
}
...
class ChildVisitor implements Visitor {
  ...
  visitRollerCoaster(rollerCoaster: RollerCoaster): void {
    console.log(`
        Nino en montana rusa: Precio con descuento de ${ rollerCoaster.getPrice() * 0.5}    
    `);
  ...
  visitHauntedHouse(hauntedHouse: HauntedHouse): void {
    console.log(`
        Nino en casa del terror: Precio con descuento de ${ hauntedHouse.getPrice() * 0.7}    
    `);
  ...
  visirFerrisWheel(ferrisWheel: FerrisWheel): void {
    console.log(`
        Nino en la rueda de la fortuna: Precio con descuento de ${ ferrisWheel.getPrice() * 0.6}    
    `);
  }
...
class AdultVisitor implements Visitor {
    ...
    visitRollerCoaster(rollerCoaster: RollerCoaster): void {
      console.log(`
          Adulto en montana rusa: Precio con descuento de ${ rollerCoaster.getPrice()}    
      `);
...
class SeniorVisitor implements Visitor {
    ...
    visitRollerCoaster(rollerCoaster: RollerCoaster): void {
        console.log(`
            Adulto mayor en montana rusa: Precio con descuento de ${ rollerCoaster.getPrice() * 0.85}    
        `);
